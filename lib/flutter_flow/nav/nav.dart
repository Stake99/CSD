...
class AppStateNotifier extends ChangeNotifier {
  MollyFirebaseUser? initialUser;
  MollyFirebaseUser? user;
  ...
  void update(MollyFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? AllsetWidget() : SignupWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'HomeP',
              path: 'homeP',
              builder: (context, params) => HomePWidget(),
            ),
            FFRoute(
              name: 'Explore',
              path: 'explore',
